...
export function SiteShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-[#07090d] text-[#f5f7ff]">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#07090d]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#ff4655] font-black text-white shadow-[0_0_24px_rgba(255,70,85,0.28)]">
              V
            </div>
            <div>
              <div className="text-lg font-semibold tracking-[0.18em] text-white">VANTA</div>
      ...
      <footer className="border-t border-white/10 bg-[#0b0f16]">
