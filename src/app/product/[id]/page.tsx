      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <div className="rounded-[30px] border border-white/10 bg-[#18181B] p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                {product.sellerVerified && <span className="rounded-full bg-emerald-500/20 px-2 py-1 text-xs text-emerald-300">Vendeur vérifié</span>}
              </div>
          ...
          <div className="rounded-[30px] border border-white/10 bg-[#18181B] p-6">
            ...
            <div className="mt-6 flex items-end gap-3"><div className="text-4xl font-bold text-white">{Math.round(product.price * 10.8)} MAD</div><div className="pb-1 text-sm text-zinc-500">≈ €{product.price}</div></div>
            <div className="mt-6 flex gap-3">
              ...
              <button className="rounded-full border border-white/10 bg-zinc-800 px-4 py-3 font-semibold text-white">Ajouter aux favoris</button>
            </div>
            <div className="mt-6 space-y-3 text-sm text-zinc-300">
              <div className="flex justify-between border-b border-white/10 pb-2"><span>Vendeur</span><span>{product.seller}</span></div>
              <div className="flex justify-between border-b border-white/10 pb-2"><span>Jeu</span><span>{product.game}</span></div>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-[28px] border border-white/10 bg-[#18181B] p-6">
            <h2 className="text-2xl font-bold text-white">À propos du compte</h2>
          ...
          <div className="rounded-[28px] border border-white/10 bg-[#18181B] p-6">
            <h2 className="text-2xl font-bold text-white">Protection acheteur</h2>
            <ul className="mt-6 space-y-4 text-zinc-300">
              <li>✓ Paiement sécurisé via CMI ou PayPal</li>
              <li>✓ Livraison suivie par ticket Discord</li>
              <li>✓ Vérification du vendeur avant publication</li>
